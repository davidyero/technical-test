        ...
        <>
          <div className='detail__container'>
            <div className='detail__container--back'>
              <div
                onClick={handleBack}
                className='detail__container--back-action'
              >
                <img className='paginator__icon' src={LeftIcon} alt='left' />
                <label className='detail__container--back-text'>
                  {t('back')}
                </label>
              </div>
            </div>
            <img
              className='detail__row--image'
              src={product.image}
              alt='product'
            />
            <div className='detail__container--info'>
              <label className='detail__row'>
                ...
                <span className='detail__row--text'>{product?.id}</span>
              </label>
              <label className='detail__row'>
              ...
              <label className='detail__row'>
                ...
                <span className='detail__row--text'>{product?.price}</span>
              </label>
              <label className='detail__row'>
                <span className='detail__row--title'>{t('disk')}: </span>
                <span className='detail__row--text'>{product?.data.disk}</span>
              </label>
              <label className='detail__row'>
                <span className='detail__row--title'>{t('cpu')}: </span>
                <span className='detail__row--text'>{product?.data.cpu}</span>
              </label>
              <label className='detail__row'>
                <span className='detail__row--title'>{t('gpu')}: </span>
                <span className='detail__row--text'>{product?.data.gpu}</span>
              </label>
              <label className='detail__row'>
                <span className='detail__row--title'>{t('ram')}: </span>
                <span className='detail__row--text'>{product?.data.ram}</span>
              </label>
              <label className='detail__row'>
