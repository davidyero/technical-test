...
import {IS_GUESS, USER_STORAGE} from "../../shared/constants/LocalStorages.constants.ts";
      ...
      <SuperCard className={"login__card"} onClick={()=>{}}>
        ...
        <div className="login__container--right">
          <div className="login__form">
            ...
            <SuperButton isDisabled={email === '' || password === ''} text={"Login"} onClick={handleLogin}/>
            <div className="login__container-text">
              <label onClick={continueAsGuest} className="login__container-text--guess">Ingresar como invitado</label>
            </div>
          </div>
        </div>
      </SuperCard>
